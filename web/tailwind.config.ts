  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        hero:    ["clamp(2.75rem, 6.5vw, 5rem)",  { lineHeight: "1.04", letterSpacing: "-0.02em" }],
        display: ["clamp(2rem, 4vw, 3.25rem)",     { lineHeight: "1.08", letterSpacing: "-0.015em" }],
      },
      maxWidth: {
        content: "1200px",
      },
      ...
      keyframes: {
        ...
        slideUpSm:  { "0%": { opacity: "0", transform: "translateY(12px)" }, "100%": { opacity: "1", transform: "translateY(0)" } },
        marquee:    { "0%": { transform: "translateX(0)" }, "100%": { transform: "translateX(-50%)" } },
        scaleIn:    { "0%": { opacity: "0", transform: "scale(0.95)" }, "100%": { opacity: "1", transform: "scale(1)" } },
        lineExpand: { "0%": { transform: "scaleX(0)", transformOrigin: "left" }, "100%": { transform: "scaleX(1)", transformOrigin: "left" } },
      },
      transitionDuration: {
        "400": "400ms",
        "600": "600ms",
