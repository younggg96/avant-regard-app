...
const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: "/admin/archive",        labelKey: "admin.archiveAdmin.menu",  groupKey: "admin.navGroupCommunity" },
  { href: "/admin/three-views",    labelKey: "admin.threeViews.menu",    groupKey: "admin.navGroupCommunity" },
  ...
  { href: "/admin/orders",         labelKey: "admin.orders",           groupKey: "admin.navGroupTrading" },
