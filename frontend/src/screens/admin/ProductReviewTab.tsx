...
const makeStyles = (t: AppTheme) =>
  StyleSheet.create({
    ...
    flagTitle: { fontSize: 13, lineHeight: 17, color: t.colors.text, fontWeight: "600" },
    flagDescription: {
      fontSize: 11,
    ...
    empty: { fontSize: 12, color: t.colors.textSecondary },
    card: {
      backgroundColor: t.colors.surface,
      padding: 10,
      marginHorizontal: 10,
    ...
    thumbEmpty: {},
    title: { fontSize: 13, lineHeight: 17, fontWeight: "600", color: t.colors.text },
    meta: { fontSize: 11, lineHeight: 14, color: t.colors.textSecondary },
    price: { fontSize: 13, lineHeight: 17, fontWeight: "600", color: t.colors.text },
    note: { fontSize: 11, color: t.colors.textSecondary, lineHeight: 14 },
    actions: { marginTop: 8, justifyContent: "flex-end" },
    btn: {
      flexDirection: "row",
      alignItems: "center",
      gap: 4,
