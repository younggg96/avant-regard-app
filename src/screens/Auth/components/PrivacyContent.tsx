...
export const PrivacyContent: React.FC = () => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.content}>符合以下情形的，有权申请删除个人信息：</Text>
      <Text style={styles.bulletContent}>• 收集目的已实现或无需继续存储；</Text>
      <Text style={styles.bulletContent}>• 您撤回同意；</Text>
      <Text style={styles.bulletContent}>• 我们违反约定使用或处理信息；</Text>
