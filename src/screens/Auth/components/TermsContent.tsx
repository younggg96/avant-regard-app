  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.contentHighlight}>
        ...
        用户生成内容规范与零容忍政策：本平台对不当内容和滥用行为实行零容忍政策。您同意不发布、上传或传播任何具有攻击性、淫秽色情、仇恨、骚扰、歧视、暴力威胁或其他不当性质的内容。对于任何违反上述规定的内容，平台将在收到有效举报后 24 小时内予以删除，并对发布该内容的用户采取限制或永久封禁账号等措施。
      </Text>

      <Text style={styles.content}>
        <Text style={styles.subIndex}>3.8</Text>{" "}
        举报与屏蔽机制：您有权对其他用户发布的不当内容进行举报，也有权屏蔽您认为具有滥用行为的用户。屏蔽后，被屏蔽用户的内容将立即从您的动态中移除。甲方将根据举报内容对违规用户采取相应处理措施，包括但不限于删除相关内容、限制账号功能或永久封禁账号。
      </Text>
